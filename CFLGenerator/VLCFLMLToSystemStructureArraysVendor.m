//
//  VLCFLMLToSystemStructureArraysVendor.m
//  CFLGenerator
//
...
#import "VLCFLMLToSystemStructureArraysVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCFLMLToSystemStructureArraysVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateCalculateSystemArraysBufferWithOptions:options];
