//
//  VLCFLMLToMappingMatrixVendor.m
//  CFLGenerator
//
...
#import "VLCFLMLToMappingMatrixVendor.h"
#import "VLAbstractLanguageAdaptor.h"


@implementation VLCFLMLToMappingMatrixVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateMappingMatrixBufferWithOptions:options];
