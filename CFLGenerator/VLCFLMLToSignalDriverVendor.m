...
#import "VLCFLMLToSignalDriverVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCFLMLToSignalDriverVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateSignalDriverBufferWithOptions:options];
