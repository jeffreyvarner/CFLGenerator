...
#import "VLCFLMLToGraphVizDotVendor.h"

@implementation VLCFLMLToGraphVizDotVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateGraphvizNetworkVisualizationBufferWithOptions:options];
